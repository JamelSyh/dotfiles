...
vim.api.nvim_set_keymap('n', '<F5>', ':SnipRun<CR>', { silent = true })
...
-- Enable the Language Server Protocol for Liquid files
...
vim.cmd("let g:syntastic_python_checkers=['mypy']")
-- vim.cmd("let g:user_emmet_leader_key='<C-n>'")
